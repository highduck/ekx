...
export async function buildDev(ctx: Project): Promise<any> {
    ...
    const materialIconsFont = path.resolve(__dirname, "../../../external/dev-fonts/ttf/MaterialIcons-Regular.ttf");
    const awesomeIconsFont = path.resolve(__dirname, "../../../external/dev-fonts/ttf/fa-solid-900.ttf");
    ...
    const sfPro = path.resolve(__dirname, "../../../packages/dev-tools/assets/sf-pro-text-regular.ttf");
    const sfMono = path.resolve(__dirname, "../../../packages/dev-tools/assets/sf-mono-text-regular.ttf");
