...
mesh_data_t create_cube(const float3& position, const float3& size, argb32_t color) {
    mesh_data_t result;
...
mesh_data_t create_plane(const float3& position, const float2& size, argb32_t color) {
    mesh_data_t result;
