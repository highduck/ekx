...
/*
    ...
    Cmdline: sokol-shdc -i scenex/ek/scenex/3d/render3d.glsl -o scenex/ek/scenex/3d/render3d_shader.h -l glsl330:glsl300es:glsl100:hlsl5:metal_ios:metal_sim:metal_macos
